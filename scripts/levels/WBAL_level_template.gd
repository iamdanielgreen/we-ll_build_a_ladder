# DEGREE SHOW BUILD 01: "WE'LL MAKE A MOVEMENT"
...
@onready var player_left: CharacterBody2D = $Players/MovementLeft
@onready var player_right: CharacterBody2D = $Players/MovementRight
