...
@onready var tutorial_prompts: Control = $UI/TutorialPrompts



@onready var player_left: CharacterBody2D = $Players/JumpLeft
@onready var player_right: CharacterBody2D = $Players/JumpRight


@onready var level_win_screen: CanvasLayer = $UI/LevelWinMenu
@onready var restart_button: Button = $UI/LevelWinMenu/LevelWinMenu_Buttons/restart_button
